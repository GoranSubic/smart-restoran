...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="img/480-Cuisine1.jpg" alt="Food">
        ...
        <div class="item">
            <img src="img/480-Cuisine2.jpg" alt="Food">
            <div class="carousel-caption">
                <h1>Food around the world</h1>
                <!-- p>The atmosphere in Chania has a touch of Florence and Venice.</p-->
            </div>
        ...
        <div class="item">
            <img src="img/480-Cuisine3.jpg" alt="Food">
            <div class="carousel-caption">
                <h1>Food around the world</h1>
        ...
        <div class="item">
            <img src="img/480-Cuisine4.jpg" alt="Food">
            <div class="carousel-caption">
                <h1>Food around the world</h1>
                <!--p>Beatiful flowers in Kolymbari, Crete.</p-->
            </div>
        ...
        <div class="item">
            <img src="img/480-CuisinePig3.jpg" alt="Food">
            <div class="carousel-caption">
                <h1>Food around the world</h1>
                <!--p>Beatiful flowers in Kolymbari, Crete.</p-->
            </div>
        ...
        <div class="item">
            <img src="img/480-CuisineSouthAfrica.jpg" alt="Food">
            <div class="carousel-caption">
                <h1>Food around the world</h1>
                <!--p>Beatiful flowers in Kolymbari, Crete.</p-->
            </div>
        ...
        <div class="item">
            <img src="img/480-Indian_Spices.jpg" alt="Food">
            <div class="carousel-caption">
                <h1>Food around the world</h1>
                <!--p>Beatiful flowers in Kolymbari, Crete.</p-->
            </div>
